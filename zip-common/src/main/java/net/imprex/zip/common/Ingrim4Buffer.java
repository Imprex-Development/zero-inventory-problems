 ...
 * @author Ingrim4
 */
public class Ingrim4Buffer extends ByteBuf {

	private final ByteBuf buf;

	public Ingrim4Buffer(ByteBuf buf) {
		this.buf = buf;
	}
	...
	/**
	 * Reads a byte array which got write byte {@link Ingrim4Buffer#writeByteArray(byte[])}
	 * @return byte[]
	 */
